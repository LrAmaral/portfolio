        ...
        <div className="xs:w-3/4 md:w-2/4">
         ...
         <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold font-alt text-alt">
            ...
            <h2 className="xs:text-2xl md:text-4xl font-bold font-alt">
              Lucas Amaral
            </h2>
            <h3 className="xs:text-base md:text-xl mb-4">Frontend Developer && Creative Guy</h3>
            <p className="xs:text-sm text-base">
            ...
            <p className="xs:text-sm text-base">Nowadays I'm searching for my first opportunity to make my carrier at the world of programming, with you have interest at some job I have done, 
