  ...
  <div id="contact" className="w-full h-screen items-center justify-center flex">
      ...
      <div className="flex flex-col border-alt items-center gap-16">
        <div className="flex items-center flex-col gap-2">
          ...
          <div className="flex gap-4 border border-alt items-center rounded-xl p-6">
            <Link href={'mailto:amaralrdev@gmail.com'} className="hover:text-neutral-400 transition ease-in-out duration-200">amaralrdev@gmail.com</Link>
              <Link href={'https://github.com/LrAmaral'} className="hover:scale-110 ease-in-out duration-300 transition-all" target="_blank">
                <GithubIcon />
              </Link>
              <Link href={'https://www.linkedin.com/in/lucas-amaral-73650a1b0/'} className="hover:scale-110 ease-in-out duration-300 transition-all" target="_blank">
